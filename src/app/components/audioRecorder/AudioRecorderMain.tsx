...
const AudioRecorderMain = () => {
    ...
    return (
        <>
            <div className="flex justify-center items-center grow flex-col pt-16 lg:gap-8 md:gap-6 gap-4" id="audioRecorder">
                ...
                <button id="audioRecorderSettings" className="btn flex flex-row p-5 w-auto h-auto gap-x-4" onClick={() => (document.getElementById("recorderSettingsModal")! as HTMLDialogElement).showModal()}>
                    <div className="fill-base-content">
