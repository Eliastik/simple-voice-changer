...
const Navbar = () => {
    ...
    return (
        <>
            <div className="navbar bg-primary text-white fixed z-50">
                {(audioEditorReady || audioRecorderReady) && <div className="flex-none btn btn-ghost normal-case text-xl pl-3 pr-3" onClick={() => (document.getElementById("modalGoToHome")! as any).showModal()}>
                ...
                <div className="flex-none">
                    <button className="btn btn-square btn-ghost" onClick={() => (document.getElementById("modalSettings")! as any).showModal()}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                    ...
                    <button className="btn btn-square btn-ghost" onClick={() => (document.getElementById("modalInfos")! as any).showModal()}>
