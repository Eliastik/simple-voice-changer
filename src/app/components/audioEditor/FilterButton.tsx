    ...
    return (
        <>
            <div className="join join-vertical w-36">
                <button className={`btn flex-col w-full h-36 gap-8 rounded-b-none border-0 ${enabled ? "bg-blue-200 hover:bg-blue-300" : ""}`} onClick={() => toggleFilter(filter.filterId)}>
                ...
                <div className="flex join">
                    {filter.hasSettings && <button className={`btn flex-grow p-0 flex-col border-l-0 border-b-0 h-1 border-t-1 rounded-t-none rounded-br-none ${enabled ? "bg-blue-200 hover:bg-blue-300 border-t-blue-300 border-r-blue-300 hover:border-t-blue-300 hover:border-r-blue-300" : "border-t-gray-300 border-r-gray-300 hover:border-t-gray-300 hover:border-r-gray-300"}`} onClick={() => filter.settingsForm && (document.getElementById(`modalSettings_${filter.filterId}`) as any).showModal()}>
