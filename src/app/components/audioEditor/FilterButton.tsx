...
const FilterButton = ({
    ...
    settingsModalTitle,
    settingsForm
}: { filterId: string, filterName: string, filterIcon: JSX.Element, enabled: boolean, hasSettings: boolean, info: string, settingsModalTitle?: string, settingsForm?: SettingForm[] }) => {
    ...
    return (
        <>
            ...
            <dialog id={`modalInfos_${filterId}`} className="modal">
            ...
            {settingsForm &&
                <dialog id={`modalSettings_${filterId}`} className="modal">
                    <FilterSettingsForm filterId={filterId} settingsModalTitle={settingsModalTitle} settingsForm={settingsForm}></FilterSettingsForm>
                </dialog>
            }
        </>
    )
